<?php
if ( class_exists( 'WPAdminButtons_AdminPageFramework_FieldType' ) && ! class_exists( 'WPAdminButtons_RevealerCustomFieldType' ) ) :
class WPAdminButtons_RevealerCustomFieldType extends WPAdminButtons_AdminPageFramework_FieldType {
