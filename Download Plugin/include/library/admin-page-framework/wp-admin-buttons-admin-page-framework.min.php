<?php 
/**
	Admin Page Framework - Minified Version v3.5.2b04 by Michael Uno 
	Generated by PHP Class Minifier <https://github.com/michaeluno/PHP-Class-Files-Script-Generator>
	<http://en.michaeluno.jp/admin-page-framework>
	Copyright (c) 2013-2015, Michael Uno; Licensed under MIT <http://opensource.org/licenses/MIT> */
abstract class WPAdminButtons_AdminPageFramework_Registry_Base {
    const Version = '3.5.2b04';
...
final class WPAdminButtons_AdminPageFramework_Registry extends WPAdminButtons_AdminPageFramework_Registry_Base {
    ...
    static function setUp($sFilePath = null) {
        ...
        self::$sAutoLoaderPath = self::$sDirPath . '/factory/WPAdminButtons_AdminPageFramework_Factory/utility/WPAdminButtons_AdminPageFramework_RegisterClasses.php';
        self::$bIsMinifiedVersion = class_exists('WPAdminButtons_AdminPageFramework_MinifiedVersionHeader');
    }
...
final class WPAdminButtons_AdminPageFramework_Bootstrap {
    function __construct($sLibraryPath) {
        ...
        WPAdminButtons_AdminPageFramework_Registry::setUp($sLibraryPath);
        if (WPAdminButtons_AdminPageFramework_Registry::$bIsMinifiedVersion) {
            return;
        }
        include (WPAdminButtons_AdminPageFramework_Registry::$sAutoLoaderPath);
        include (WPAdminButtons_AdminPageFramework_Registry::$sDirPath . '/admin-page-framework-include-class-list.php');
        new WPAdminButtons_AdminPageFramework_RegisterClasses(isset($aClassFiles) ? '' : WPAdminButtons_AdminPageFramework_Registry::$sDirPath, array('exclude_class_names' => 'WPAdminButtons_AdminPageFramework_MinifiedVersionHeader',), isset($aClassFiles) ? $aClassFiles : array());
    }
}
new WPAdminButtons_AdminPageFramework_Bootstrap(__FILE__);
abstract class WPAdminButtons_AdminPageFramework_Factory_Router {
    public $oProp;
    public $oDebug;
    public $oUtil;
    public $oMsg;
    ...
    protected function _getFormInstance($oProp) {
        switch ($oProp->sFieldsType) {
            ...
            case 'network_admin_page':
                ...
                return new WPAdminButtons_AdminPageFramework_FormElement_Page($oProp->sFieldsType, $oProp->sCapability, $this);
            case 'post_meta_box':
            case 'page_meta_box':
            case 'post_type':
                if ($oProp->bIsAdminAjax) {
                ...
                return new WPAdminButtons_AdminPageFramework_FormElement($oProp->sFieldsType, $oProp->sCapability, $this);
            case 'taxonomy':
            case 'widget':
            case 'user_meta':
                return new WPAdminButtons_AdminPageFramework_FormElement($oProp->sFieldsType, $oProp->sCapability, $this);
    ...
    protected function _getResourceInstance($oProp) {
        switch ($oProp->sFieldsType) {
            case 'page':
            case 'network_admin_page':
                return new WPAdminButtons_AdminPageFramework_Resource_Page($oProp);
            case 'post_meta_box':
                return new WPAdminButtons_AdminPageFramework_Resource_MetaBox($oProp);
            case 'page_meta_box':
                return new WPAdminButtons_AdminPageFramework_Resource_MetaBox_Page($oProp);
            case 'post_type':
                return new WPAdminButtons_AdminPageFramework_Resource_PostType($oProp);
            case 'taxonomy':
                return new WPAdminButtons_AdminPageFramework_Resource_TaxonomyField($oProp);
            case 'widget':
                return new WPAdminButtons_AdminPageFramework_Resource_Widget($oProp);
            case 'user_meta':
                return new WPAdminButtons_AdminPageFramework_Resource_UserMeta($oProp);
        }
    }
    protected function _getHelpPaneInstance($oProp) {
        switch ($oProp->sFieldsType) {
            case 'page':
            case 'network_admin_page':
                return new WPAdminButtons_AdminPageFramework_HelpPane_Page($oProp);
            case 'post_meta_box':
                return new WPAdminButtons_AdminPageFramework_HelpPane_MetaBox($oProp);
            case 'page_meta_box':
                return new WPAdminButtons_AdminPageFramework_HelpPane_MetaBox_Page($oProp);
            case 'post_type':
                return null;
            case 'taxonomy':
                return new WPAdminButtons_AdminPageFramework_HelpPane_TaxonomyField($oProp);
            case 'widget':
                return new WPAdminButtons_AdminPageFramework_HelpPane_Widget($oProp);
            case 'user_meta':
                return new WPAdminButtons_AdminPageFramework_HelpPane_UserMeta($oProp);
        }
    }
    protected function _getLinkInstancce($oProp, $oMsg) {
        switch ($oProp->sFieldsType) {
            case 'page':
                return new WPAdminButtons_AdminPageFramework_Link_Page($oProp, $oMsg);
            case 'network_admin_page':
                return new WPAdminButtons_AdminPageFramework_Link_NetworkAdmin($oProp, $oMsg);
            case 'post_meta_box':
                return null;
            case 'page_meta_box':
                return null;
            case 'post_type':
                return new WPAdminButtons_AdminPageFramework_Link_PostType($oProp, $oMsg);
            case 'taxonomy':
            case 'widget':
            case 'user_meta':
            default:
    ...
    protected function _getPageLoadInfoInstance($oProp, $oMsg) {
        switch ($oProp->sFieldsType) {
            case 'page':
                return WPAdminButtons_AdminPageFramework_PageLoadInfo_Page::instantiate($oProp, $oMsg);
            case 'network_admin_page':
                return WPAdminButtons_AdminPageFramework_PageLoadInfo_NetworkAdminPage::instantiate($oProp, $oMsg);
            case 'post_meta_box':
                return null;
            case 'page_meta_box':
                return null;
            case 'post_type':
                return WPAdminButtons_AdminPageFramework_PageLoadInfo_PostType::instantiate($oProp, $oMsg);
            case 'taxonomy':
            case 'widget':
            default:
                return null;
    ...
    function __get($sPropertyName) {
        switch ($sPropertyName) {
            case 'oUtil':
                ...
                return $this->oUtil;
            case 'oDebug':
                $this->oDebug = new WPAdminButtons_AdminPageFramework_Debug;
                return $this->oDebug;
            case 'oMsg':
                $this->oMsg = WPAdminButtons_AdminPageFramework_Message::getInstance($this->oProp->sTextDomain);
                return $this->oMsg;
            case 'oForm':
...
abstract class WPAdminButtons_AdminPageFramework_Factory_Model extends WPAdminButtons_AdminPageFramework_Factory_Router {
    ...
    protected function _loadFieldTypeDefinitions() {
        if (empty(self::$_aFieldTypeDefinitions)) {
            self::$_aFieldTypeDefinitions = WPAdminButtons_AdminPageFramework_FieldTypeRegistration::register(array(), $this->oProp->sClassName, $this->oMsg);
        }
    ...
    protected function _registerField(array $aField) {
        WPAdminButtons_AdminPageFramework_FieldTypeRegistration::_setFieldResources($aField, $this->oProp, $this->oResource);
        if ($aField['help']) {
    ...
    protected function _isValidationErrors() {
        if (isset($GLOBALS['aWPAdminButtons_AdminPageFramework']['aFieldErrors']) && $GLOBALS['aWPAdminButtons_AdminPageFramework']['aFieldErrors']) {
            return true;
        }
    ...
    public function _replyToSaveFieldErrors() {
        if (!isset($GLOBALS['aWPAdminButtons_AdminPageFramework']['aFieldErrors'])) {
            return;
        }
        $this->oUtil->setTransient("apf_field_erros_" . get_current_user_id(), $GLOBALS['aWPAdminButtons_AdminPageFramework']['aFieldErrors'], 300);
    }
    public function _replyToSaveNotices() {
        if (!isset($GLOBALS['aWPAdminButtons_AdminPageFramework']['aNotices'])) {
            return;
        }
        if (empty($GLOBALS['aWPAdminButtons_AdminPageFramework']['aNotices'])) {
            return;
        }
        $this->oUtil->setTransient('apf_notices_' . get_current_user_id(), $GLOBALS['aWPAdminButtons_AdminPageFramework']['aNotices']);
    }
...
abstract class WPAdminButtons_AdminPageFramework_Factory_View extends WPAdminButtons_AdminPageFramework_Factory_Model {
    function __construct($oProp) {
    ...
    public function _replyToGetFieldOutput($aField) {
        $_oField = new WPAdminButtons_AdminPageFramework_FormField($aField, $this->oProp->aOptions, $this->_getFieldErrors(), $this->oProp->aFieldTypeDefinitions, $this->oMsg, $this->oProp->aFieldCallbacks);
...
abstract class WPAdminButtons_AdminPageFramework_Factory_Controller extends WPAdminButtons_AdminPageFramework_Factory_View {
    ...
    public function setFieldErrors($aErrors) {
        $GLOBALS['aWPAdminButtons_AdminPageFramework']['aFieldErrors'] = isset($GLOBALS['aWPAdminButtons_AdminPageFramework']['aFieldErrors']) ? $GLOBALS['aWPAdminButtons_AdminPageFramework']['aFieldErrors'] : array();
        if (empty($GLOBALS['aWPAdminButtons_AdminPageFramework']['aFieldErrors'])) {
            add_action('shutdown', array($this, '_replyToSaveFieldErrors'));
        }
        $_sID = md5($this->oProp->sClassName);
        $GLOBALS['aWPAdminButtons_AdminPageFramework']['aFieldErrors'][$_sID] = isset($GLOBALS['aWPAdminButtons_AdminPageFramework']['aFieldErrors'][$_sID]) ? $this->oUtil->uniteArrays($GLOBALS['aWPAdminButtons_AdminPageFramework']['aFieldErrors'][$_sID], $aErrors) : $aErrors;
    }
    public function hasFieldError() {
        return isset($GLOBALS['aWPAdminButtons_AdminPageFramework']['aFieldErrors'][md5($this->oProp->sClassName) ]);
    }
    public function setSettingNotice($sMessage, $sType = 'error', $asAttributes = array(), $bOverride = true) {
        $GLOBALS['aWPAdminButtons_AdminPageFramework']['aNotices'] = isset($GLOBALS['aWPAdminButtons_AdminPageFramework']['aNotices']) ? $GLOBALS['aWPAdminButtons_AdminPageFramework']['aNotices'] : array();
        if (empty($GLOBALS['aWPAdminButtons_AdminPageFramework']['aNotices'])) {
            add_action('shutdown', array($this, '_replyToSaveNotices'));
        }
        $_sID = md5(trim($sMessage));
        if ($bOverride || !isset($GLOBALS['aWPAdminButtons_AdminPageFramework']['aNotices'][$_sID])) {
            ...
            $GLOBALS['aWPAdminButtons_AdminPageFramework']['aNotices'][$_sID] = array('sMessage' => $sMessage, 'aAttributes' => $_aAttributes + array('class' => $sType, 'id' => $this->oProp->sClassName . '_' . $_sID,),);
        }
    }
    public function hasSettingNotice($sType = '') {
        $_aNotices = isset($GLOBALS['aWPAdminButtons_AdminPageFramework']['aNotices']) ? $GLOBALS['aWPAdminButtons_AdminPageFramework']['aNotices'] : array();
        if (!$sType) {
...
abstract class WPAdminButtons_AdminPageFramework_Factory extends WPAdminButtons_AdminPageFramework_Factory_Controller {
}
abstract class WPAdminButtons_AdminPageFramework_Router extends WPAdminButtons_AdminPageFramework_Factory {
    ...
    function __construct($sOptionKey = null, $sCallerPath = null, $sCapability = 'manage_options', $sTextDomain = 'admin-page-framework') {
        $this->oProp = isset($this->oProp) ? $this->oProp : new WPAdminButtons_AdminPageFramework_Property_Page($this, $sCallerPath, get_class($this), $sOptionKey, $sCapability, $sTextDomain);
...
abstract class WPAdminButtons_AdminPageFramework_Form_Model_Port extends WPAdminButtons_AdminPageFramework_Router {
    protected function _importOptions($aStoredOptions, $sPageSlug, $sTabSlug) {
        $oImport = new WPAdminButtons_AdminPageFramework_ImportOptions($_FILES['__import'], $_POST['__import']);
    ...
    protected function _exportOptions($vData, $sPageSlug, $sTabSlug) {
        $oExport = new WPAdminButtons_AdminPageFramework_ExportOptions($_POST['__export'], $this->oProp->sClassName);
...
abstract class WPAdminButtons_AdminPageFramework_MetaBox_Router extends WPAdminButtons_AdminPageFramework_Factory {
    function __construct($sMetaBoxID, $sTitle, $asPostTypeOrScreenID = array('post'), $sContext = 'normal', $sPriority = 'default', $sCapability = 'edit_posts', $sTextDomain = 'admin-page-framework') {
        ...
        $_sClassName = get_class($this);
        parent::__construct(isset($this->oProp) ? $this->oProp : new WPAdminButtons_AdminPageFramework_Property_MetaBox($this, $_sClassName, $sCapability));
...
abstract class WPAdminButtons_AdminPageFramework_MetaBox_Model extends WPAdminButtons_AdminPageFramework_MetaBox_Router {
    ...
    protected function _setOptionArray($iPostID, $aFields) {
        ...
        $this->oProp->aOptions = WPAdminButtons_AdminPageFramework_WPUtility::addAndApplyFilter($this, 'options_' . $this->oProp->sClassName, $this->oProp->aOptions);
        $_aLastInput = isset($_GET['field_errors']) && $_GET['field_errors'] ? $this->oProp->aLastInput : array();
        $this->oProp->aOptions = empty($this->oProp->aOptions) ? array() : WPAdminButtons_AdminPageFramework_WPUtility::getAsArray($this->oProp->aOptions);
...
abstract class WPAdminButtons_AdminPageFramework_PostType_Router extends WPAdminButtons_AdminPageFramework_Factory {
    public function _isInThePage() {
        if (!$this->oProp->bIsAdmin) {
            return false;
        }
...
abstract class WPAdminButtons_AdminPageFramework_PostType_Model extends WPAdminButtons_AdminPageFramework_PostType_Router {
    function __construct($oProp) {
        parent::__construct($oProp);
...
abstract class WPAdminButtons_AdminPageFramework_TaxonomyField_Router extends WPAdminButtons_AdminPageFramework_Factory {
...
abstract class WPAdminButtons_AdminPageFramework_TaxonomyField_Model extends WPAdminButtons_AdminPageFramework_TaxonomyField_Router {
...
abstract class WPAdminButtons_AdminPageFramework_UserMeta_Router extends WPAdminButtons_AdminPageFramework_Factory {
    public function __construct($oProp) {
        parent::__construct($oProp);
        if ($this->oProp->bIsAdmin) {
            add_action('wp_loaded', array($this, '_replyToDetermineToLoad'));
...
abstract class WPAdminButtons_AdminPageFramework_UserMeta_Model extends WPAdminButtons_AdminPageFramework_UserMeta_Router {
    public function _replyToRegisterFormElements($oScreen) {
        $this->_loadFieldTypeDefinitions();
        $this->oForm->format();
        $this->oForm->applyConditions();
    ...
    protected function _setOptionArray($iUserID) {
        ...
        $_aOptions = WPAdminButtons_AdminPageFramework_WPUtility::addAndApplyFilter($this, 'options_' . $this->oProp->sClassName, $_aOptions);
        $_aLastInput = isset($_GET['field_errors']) && $_GET['field_errors'] ? $this->oProp->aLastInput : array();
        $_aOptions = empty($_aOptions) ? array() : WPAdminButtons_AdminPageFramework_WPUtility::getAsArray($_aOptions);
...
abstract class WPAdminButtons_AdminPageFramework_Widget_Router extends WPAdminButtons_AdminPageFramework_Factory {
    public function __call($sMethodName, $aArgs = null) {
        if ('setup_pre' === $sMethodName) {
            $this->_setUp();
            $this->oUtil->addAndDoAction($this, "set_up_{$this->oProp->sClassName}", $this);
...
abstract class WPAdminButtons_AdminPageFramework_Widget_Model extends WPAdminButtons_AdminPageFramework_Widget_Router {
    function __construct($oProp) {
        parent::__construct($oProp);
    ...
    public function _replyToRegisterWidget() {
        ...
        $wp_widget_factory->widgets[$this->oProp->sClassName] = new WPAdminButtons_AdminPageFramework_Widget_Factory($this, $this->oProp->sWidgetTitle, is_array($this->oProp->aWidgetArguments) ? $this->oProp->aWidgetArguments : array());
    }
...
abstract class WPAdminButtons_AdminPageFramework_Form_Model_Validation extends WPAdminButtons_AdminPageFramework_Form_Model_Port {
...
abstract class WPAdminButtons_AdminPageFramework_Form_Model extends WPAdminButtons_AdminPageFramework_Form_Model_Validation {
    ...
    public function _replyToSendFormEmail() {
        ...
        $_oEmail = new WPAdminButtons_AdminPageFramework_FormEmail($_aFormEmail['email_options'], $_aFormEmail['input'], $_aFormEmail['section_id']);
        $_bSent = $_oEmail->send();
        exit;
    }
...
abstract class WPAdminButtons_AdminPageFramework_MetaBox_View extends WPAdminButtons_AdminPageFramework_MetaBox_Model {
    public function _replyToPrintMetaBoxContents($oPost, $vArgs) {
        ...
        $_oFieldsTable = new WPAdminButtons_AdminPageFramework_FormTable($this->oProp->aFieldTypeDefinitions, $this->_getFieldErrors(), $this->oMsg);
...
abstract class WPAdminButtons_AdminPageFramework_MetaBox_Controller extends WPAdminButtons_AdminPageFramework_MetaBox_View {
    public function setUp() {
    }
...
abstract class WPAdminButtons_AdminPageFramework_MetaBox extends WPAdminButtons_AdminPageFramework_MetaBox_Controller {
    static protected $_sFieldsType = 'post_meta_box';
    function __construct($sMetaBoxID, $sTitle, $asPostTypeOrScreenID = array('post'), $sContext = 'normal', $sPriority = 'default', $sCapability = 'edit_posts', $sTextDomain = 'admin-page-framework') {
        if (!$this->_isInstantiatable()) {
            return;
        }
        $this->oProp = new WPAdminButtons_AdminPageFramework_Property_MetaBox($this, get_class($this), $sCapability, $sTextDomain, self::$_sFieldsType);
...
abstract class WPAdminButtons_AdminPageFramework_PostType_View extends WPAdminButtons_AdminPageFramework_PostType_Model {
    function __construct($oProp) {
        parent::__construct($oProp);
        if ($this->_isInThePage()) {
...
abstract class WPAdminButtons_AdminPageFramework_PostType_Controller extends WPAdminButtons_AdminPageFramework_PostType_View {
    function __construct($oProp) {
        parent::__construct($oProp);
        if (did_action('init')) {
            $this->setup_pre();
...
abstract class WPAdminButtons_AdminPageFramework_PostType extends WPAdminButtons_AdminPageFramework_PostType_Controller {
    public function __construct($sPostType, $aArgs = array(), $sCallerPath = null, $sTextDomain = 'admin-page-framework') {
        if (empty($sPostType)) {
            return;
        }
        $this->oProp = new WPAdminButtons_AdminPageFramework_Property_PostType($this, $sCallerPath ? trim($sCallerPath) : ((is_admin() && isset($GLOBALS['pagenow']) && in_array($GLOBALS['pagenow'], array('edit.php', 'post.php', 'post-new.php', 'plugins.php', 'tags.php', 'edit-tags.php',))) ? WPAdminButtons_AdminPageFramework_Utility::getCallerScriptPath(__FILE__) : null), get_class($this), 'publish_posts', $sTextDomain, 'post_type');
        $this->oProp->sPostType = WPAdminButtons_AdminPageFramework_WPUtility::sanitizeSlug($sPostType);
        $this->oProp->aPostTypeArgs = $aArgs;
        parent::__construct($this->oProp);
        $this->oUtil->addAndDoAction($this, "start_{$this->oProp->sClassName}", $this);
    }
}
abstract class WPAdminButtons_AdminPageFramework_TaxonomyField_View extends WPAdminButtons_AdminPageFramework_TaxonomyField_Model {
...
abstract class WPAdminButtons_AdminPageFramework_TaxonomyField_Controller extends WPAdminButtons_AdminPageFramework_TaxonomyField_View {
    public function setUp() {
    }
}
abstract class WPAdminButtons_AdminPageFramework_TaxonomyField extends WPAdminButtons_AdminPageFramework_TaxonomyField_Controller {
    ...
    function __construct($asTaxonomySlug, $sOptionKey = '', $sCapability = 'manage_options', $sTextDomain = 'admin-page-framework') {
        ...
        $this->oProp = new WPAdminButtons_AdminPageFramework_Property_TaxonomyField($this, get_class($this), $sCapability, $sTextDomain, self::$_sFieldsType);
...
abstract class WPAdminButtons_AdminPageFramework_UserMeta_View extends WPAdminButtons_AdminPageFramework_UserMeta_Model {
    public function content($sContent) {
        return $sContent;
    }
...
abstract class WPAdminButtons_AdminPageFramework_UserMeta_Controller extends WPAdminButtons_AdminPageFramework_UserMeta_View {
    public function setUp() {
    }
    public function enqueueStyles($aSRCs, $aPostTypes = array(), $aCustomArgs = array()) {
        return $this->oResource->_enqueueStyles($aSRCs, $aPostTypes, $aCustomArgs);
...
abstract class WPAdminButtons_AdminPageFramework_UserMeta extends WPAdminButtons_AdminPageFramework_UserMeta_Controller {
    ...
    public function __construct($sCapability = 'edit_user', $sTextDomain = 'admin-page-framework') {
        $this->oProp = new WPAdminButtons_AdminPageFramework_Property_UserMeta($this, get_class($this), $sCapability, $sTextDomain, self::$_sFieldsType);
        parent::__construct($this->oProp);
        $this->oUtil->addAndDoAction($this, "start_{$this->oProp->sClassName}");
    }
}
abstract class WPAdminButtons_AdminPageFramework_Widget_View extends WPAdminButtons_AdminPageFramework_Widget_Model {
...
abstract class WPAdminButtons_AdminPageFramework_Widget_Controller extends WPAdminButtons_AdminPageFramework_Widget_View {
    function __construct($oProp) {
        parent::__construct($oProp);
        if ($this->_isInThePage()):
            if (did_action('widgets_init')) {
...
abstract class WPAdminButtons_AdminPageFramework_Widget extends WPAdminButtons_AdminPageFramework_Widget_Controller {
    ...
    public function __construct($sWidgetTitle, $aWidgetArguments = array(), $sCapability = 'edit_theme_options', $sTextDomain = 'admin-page-framework') {
        ...
        $this->oProp = new WPAdminButtons_AdminPageFramework_Property_Widget($this, null, get_class($this), $sCapability, $sTextDomain, self::$_sFieldsType);
...
abstract class WPAdminButtons_AdminPageFramework_Form_View extends WPAdminButtons_AdminPageFramework_Form_Model {
    public function _replyToGetSectionHeaderOutput($sSectionDescription, $aSection) {
        return $this->oUtil->addAndApplyFilters($this, array('section_head_' . $this->oProp->sClassName . '_' . $aSection['section_id']), $sSectionDescription);
    }
    public function _replyToGetFieldOutput($aField) {
        ...
        $_oField = new WPAdminButtons_AdminPageFramework_FormField($aField, $_aTemp, $this->aFieldErrors, $this->oProp->aFieldTypeDefinitions, $this->oMsg);
...
abstract class WPAdminButtons_AdminPageFramework_Form_Controller extends WPAdminButtons_AdminPageFramework_Form_View {
    public function addSettingSections($aSection1, $aSection2 = null, $_and_more = null) {
        foreach (func_get_args() as $asSection) {
            $this->addSettingSection($asSection);
        }
    ...
    public function getValue() {
        ...
        return WPAdminButtons_AdminPageFramework_WPUtility::getOption($this->oProp->sOptionKey, $_aParams, null, $this->getSavedOptions() + $this->oProp->getDefaultOptions($this->oForm->aFields));
    }
...
abstract class WPAdminButtons_AdminPageFramework_MetaBox_Page_Router extends WPAdminButtons_AdminPageFramework_MetaBox_View {
...
abstract class WPAdminButtons_AdminPageFramework_MetaBox_Page_Model extends WPAdminButtons_AdminPageFramework_MetaBox_Page_Router {
    static protected $_sFieldsType = 'page_meta_box';
    function __construct($sMetaBoxID, $sTitle, $asPageSlugs = array(), $sContext = 'normal', $sPriority = 'default', $sCapability = 'manage_options', $sTextDomain = 'admin-page-framework') {
        $this->oProp = new WPAdminButtons_AdminPageFramework_Property_MetaBox_Page($this, get_class($this), $sCapability, $sTextDomain, self::$_sFieldsType);
...
abstract class WPAdminButtons_AdminPageFramework_Page_Model extends WPAdminButtons_AdminPageFramework_Form_Controller {
...
abstract class WPAdminButtons_AdminPageFramework_MetaBox_Page_View extends WPAdminButtons_AdminPageFramework_MetaBox_Page_Model {
}
abstract class WPAdminButtons_AdminPageFramework_MetaBox_Page_Controller extends WPAdminButtons_AdminPageFramework_MetaBox_Page_View {
...
abstract class WPAdminButtons_AdminPageFramework_MetaBox_Page extends WPAdminButtons_AdminPageFramework_MetaBox_Page_Controller {
    function __construct($sMetaBoxID, $sTitle, $asPageSlugs = array(), $sContext = 'normal', $sPriority = 'default', $sCapability = 'manage_options', $sTextDomain = 'admin-page-framework') {
...
abstract class WPAdminButtons_AdminPageFramework_Page_View_MetaBox extends WPAdminButtons_AdminPageFramework_Page_Model {
    function __construct($sOptionKey = null, $sCallerPath = null, $sCapability = 'manage_options', $sTextDomain = 'admin-page-framework') {
        parent::__construct($sOptionKey, $sCallerPath, $sCapability, $sTextDomain);
        if ($this->oProp->bIsAdminAjax) {
            return;
    ...
    private function _isMetaBoxAdded($sPageSlug = '') {
        if (!isset($GLOBALS['aWPAdminButtons_AdminPageFramework']['aMetaBoxForPagesClasses']) || !is_array($GLOBALS['aWPAdminButtons_AdminPageFramework']['aMetaBoxForPagesClasses'])) {
            return false;
        }
        ...
        foreach ($GLOBALS['aWPAdminButtons_AdminPageFramework']['aMetaBoxForPagesClasses'] as $sClassName => $oMetaBox) {
    ...
    public function _replyToAddMetaboxScript() {
        if (isset($GLOBALS['aWPAdminButtons_AdminPageFramework']['bAddedMetaBoxScript']) && $GLOBALS['aWPAdminButtons_AdminPageFramework']['bAddedMetaBoxScript']) {
            return;
        }
        $GLOBALS['aWPAdminButtons_AdminPageFramework']['bAddedMetaBoxScript'] = true;
...
abstract class WPAdminButtons_AdminPageFramework_Page_View extends WPAdminButtons_AdminPageFramework_Page_View_MetaBox {
    ...
    private function _printMainContent($sPageSlug, $sTabSlug) {
        ...
        if ($this->oProp->bEnableForm && $this->oForm->isPageAdded($sPageSlug)) {
            ...
            $_oFieldsTable = new WPAdminButtons_AdminPageFramework_FormTable($this->oProp->aFieldTypeDefinitions, $this->aFieldErrors, $this->oMsg);
...
abstract class WPAdminButtons_AdminPageFramework_Page_Controller extends WPAdminButtons_AdminPageFramework_Page_View {
...
abstract class WPAdminButtons_AdminPageFramework_Menu_Model extends WPAdminButtons_AdminPageFramework_Page_Controller {
...
abstract class WPAdminButtons_AdminPageFramework_Menu_View extends WPAdminButtons_AdminPageFramework_Menu_Model {
}
abstract class WPAdminButtons_AdminPageFramework_Menu_Controller extends WPAdminButtons_AdminPageFramework_Menu_View {
    function __construct($sOptionKey = null, $sCallerPath = null, $sCapability = 'manage_options', $sTextDomain = 'admin-page-framework') {
        parent::__construct($sOptionKey, $sCallerPath, $sCapability, $sTextDomain);
        if ($this->oProp->bIsAdminAjax) {
            return;
...
abstract class WPAdminButtons_AdminPageFramework_Model extends WPAdminButtons_AdminPageFramework_Menu_Controller {
}
abstract class WPAdminButtons_AdminPageFramework_View extends WPAdminButtons_AdminPageFramework_Model {
...
abstract class WPAdminButtons_AdminPageFramework_Controller extends WPAdminButtons_AdminPageFramework_View {
    public function setUp() {
    }
    ...
    static public function getOption($sOptionKey, $asKey = null, $vDefault = null) {
        return WPAdminButtons_AdminPageFramework_WPUtility::getOption($sOptionKey, $asKey, $vDefault);
    }
}
abstract class WPAdminButtons_AdminPageFramework extends WPAdminButtons_AdminPageFramework_Controller {
    public function __construct($sOptionKey = null, $sCallerPath = null, $sCapability = 'manage_options', $sTextDomain = 'admin-page-framework') {
        if (!$this->_isInstantiatable()) {
            return;
        }
        parent::__construct($sOptionKey, $sCallerPath ? trim($sCallerPath) : $sCallerPath = (is_admin() && (isset($GLOBALS['pagenow']) && in_array($GLOBALS['pagenow'], array('plugins.php',)) || isset($_GET['page'])) ? WPAdminButtons_AdminPageFramework_Utility::getCallerScriptPath(__FILE__) : null), $sCapability, $sTextDomain);
        $this->oUtil->addAndDoAction($this, 'start_' . $this->oProp->sClassName, $this);
    }
}
abstract class WPAdminButtons_AdminPageFramework_NetworkAdmin extends WPAdminButtons_AdminPageFramework {
    ...
    public function __construct($sOptionKey = null, $sCallerPath = null, $sCapability = 'manage_network', $sTextDomain = 'admin-page-framework') {
        ...
        $sCallerPath = $sCallerPath ? $sCallerPath : WPAdminButtons_AdminPageFramework_Utility::getCallerScriptPath(__FILE__);
        $this->oProp = new WPAdminButtons_AdminPageFramework_Property_NetworkAdmin($this, $sCallerPath, get_class($this), $sOptionKey, $sCapability, $sTextDomain);
        parent::__construct($sOptionKey, $sCallerPath, $sCapability, $sTextDomain);
    }
    protected function _isInstantiatable() {
        if (isset($GLOBALS['pagenow']) && 'admin-ajax.php' === $GLOBALS['pagenow']) {
    ...
    static public function getOption($sOptionKey, $asKey = null, $vDefault = null) {
        return WPAdminButtons_AdminPageFramework_WPUtility::getSiteOption($sOptionKey, $asKey, $vDefault);
    }
}
abstract class WPAdminButtons_AdminPageFramework_Resource_Base {
    ...
    protected function _printCommonStyles($sIDPrefix, $sClassName) {
        ...
        $_sStyle = $this->oUtil->addAndApplyFilters($_oCaller, array("style_common_admin_page_framework", "style_common_{$this->oProp->sClassName}",), WPAdminButtons_AdminPageFramework_CSS::getDefaultCSS());
        $_sStyle = $this->oUtil->minifyCSS($_sStyle);
        if ($_sStyle) {
            echo "<style type='text/css' id='" . esc_attr($sIDPrefix) . "'>" . $_sStyle . "</style>";
        }
        $_sStyleIE = $this->oUtil->addAndApplyFilters($_oCaller, array("style_ie_common_admin_page_framework", "style_ie_common_{$this->oProp->sClassName}",), WPAdminButtons_AdminPageFramework_CSS::getDefaultCSSIE());
    ...
    protected function _printCommonScripts($sIDPrefix, $sClassName) {
        ...
        $_sScript = $this->oUtil->addAndApplyFilters($this->oProp->_getCallerObject(), array("script_common_admin_page_framework", "script_common_{$this->oProp->sClassName}",), WPAdminButtons_AdminPageFramework_Property_Base::$_sDefaultScript);
        if ($_sScript) {
...
class WPAdminButtons_AdminPageFramework_Resource_Page extends WPAdminButtons_AdminPageFramework_Resource_Base {
    protected function _printClassSpecificStyles($sIDPrefix) {
...
class WPAdminButtons_AdminPageFramework_Resource_MetaBox extends WPAdminButtons_AdminPageFramework_Resource_Base {
...
class WPAdminButtons_AdminPageFramework_Resource_Widget extends WPAdminButtons_AdminPageFramework_Resource_Base {
...
class WPAdminButtons_AdminPageFramework_Resource_MetaBox_Page extends WPAdminButtons_AdminPageFramework_Resource_Page {
}
class WPAdminButtons_AdminPageFramework_Resource_PostType extends WPAdminButtons_AdminPageFramework_Resource_MetaBox {
}
class WPAdminButtons_AdminPageFramework_Resource_TaxonomyField extends WPAdminButtons_AdminPageFramework_Resource_MetaBox {
...
class WPAdminButtons_AdminPageFramework_Resource_UserMeta extends WPAdminButtons_AdminPageFramework_Resource_MetaBox {
}
class WPAdminButtons_AdminPageFramework_CSS {
...
class WPAdminButtons_AdminPageFramework_Message {
    ...
    public static function getInstance($sTextDomain = 'admin-page-framework') {
        $_oInstance = isset(self::$_aInstancesByTextDomain[$sTextDomain]) && (self::$_aInstancesByTextDomain[$sTextDomain] instanceof WPAdminButtons_AdminPageFramework_Message) ? self::$_aInstancesByTextDomain[$sTextDomain] : new WPAdminButtons_AdminPageFramework_Message($sTextDomain);
...
final class WPAdminButtons_AdminPageFramework_MinifiedVersionHeader extends WPAdminButtons_AdminPageFramework_Registry_Base {
...
abstract class WPAdminButtons_AdminPageFramework_Property_Base {
    ...
    public function __construct($oCaller, $sCallerPath, $sClassName, $sCapability, $sTextDomain, $sFieldsType) {
        ...
        $GLOBALS['aWPAdminButtons_AdminPageFramework'] = isset($GLOBALS['aWPAdminButtons_AdminPageFramework']) && is_array($GLOBALS['aWPAdminButtons_AdminPageFramework']) ? $GLOBALS['aWPAdminButtons_AdminPageFramework'] : array('aFieldFlags' => array());
        $this->sPageNow = WPAdminButtons_AdminPageFramework_WPUtility::getPageNow();
    ...
    static public function _setLibraryData() {
        self::$_aLibraryData = array('sName' => WPAdminButtons_AdminPageFramework_Registry::Name, 'sURI' => WPAdminButtons_AdminPageFramework_Registry::URI, 'sScriptName' => WPAdminButtons_AdminPageFramework_Registry::Name, 'sLibraryName' => WPAdminButtons_AdminPageFramework_Registry::Name, 'sLibraryURI' => WPAdminButtons_AdminPageFramework_Registry::URI, 'sPluginName' => '', 'sPluginURI' => '', 'sThemeName' => '', 'sThemeURI' => '', 'sVersion' => WPAdminButtons_AdminPageFramework_Registry::getVersion(), 'sDescription' => WPAdminButtons_AdminPageFramework_Registry::Description, 'sAuthor' => WPAdminButtons_AdminPageFramework_Registry::Author, 'sAuthorURI' => WPAdminButtons_AdminPageFramework_Registry::AuthorURI, 'sTextDomain' => WPAdminButtons_AdminPageFramework_Registry::TextDomain, 'sDomainPath' => WPAdminButtons_AdminPageFramework_Registry::TextDomainPath, 'sNetwork' => '', '_sitewide' => '',);
    ...
    protected function getCallerInfo($sCallerPath = null) {
        ...
        if ('plugin' == $_aCallerInfo['sType']) {
            return WPAdminButtons_AdminPageFramework_WPUtility::getScriptData($_aCallerInfo['sPath'], $_aCallerInfo['sType']) + $_aCallerInfo;
        }
    ...
    protected function _getLastInput() {
        $_vValue = WPAdminButtons_AdminPageFramework_WPUtility::getTransient('apf_tfd' . md5('temporary_form_data_' . $this->sClassName . get_current_user_id()));
        if (is_array($_vValue)) {
            return $_vValue;
        }
        return array();
    ...
    public function __get($sName) {
        if ('aScriptInfo' === $sName) {
            $this->sCallerPath = $this->sCallerPath ? $this->sCallerPath : WPAdminButtons_AdminPageFramework_Utility::getCallerScriptPath(__FILE__);
...
class WPAdminButtons_AdminPageFramework_Property_Page extends WPAdminButtons_AdminPageFramework_Property_Base {
    ...
    public function __construct($oCaller, $sCallerPath, $sClassName, $sOptionKey, $sCapability = 'manage_options', $sTextDomain = 'admin-page-framework') {
        ...
        $GLOBALS['aWPAdminButtons_AdminPageFramework']['aPageClasses'] = isset($GLOBALS['aWPAdminButtons_AdminPageFramework']['aPageClasses']) && is_array($GLOBALS['aWPAdminButtons_AdminPageFramework']['aPageClasses']) ? $GLOBALS['aWPAdminButtons_AdminPageFramework']['aPageClasses'] : array();
        $GLOBALS['aWPAdminButtons_AdminPageFramework']['aPageClasses'][$sClassName] = $oCaller;
    ...
    protected function _getOptions() {
        $_aOptions = WPAdminButtons_AdminPageFramework_WPUtility::addAndApplyFilter($this->oCaller, 'options_' . $this->sClassName, $this->sOptionKey ? get_option($this->sOptionKey, array()) : array());
    ...
    private function _getDefautValue($aField) {
        $_aSubFields = WPAdminButtons_AdminPageFramework_Utility::getIntegerElements($aField);
...
class WPAdminButtons_AdminPageFramework_Property_MetaBox extends WPAdminButtons_AdminPageFramework_Property_Base {
...
class WPAdminButtons_AdminPageFramework_Property_PostType extends WPAdminButtons_AdminPageFramework_Property_Base {
    ...
    public function __construct($oCaller, $sCallerPath, $sClassName, $sCapability, $sTextDomain, $sFieldsType) {
        ...
        switch ($this->_getCallerType($sCallerPath)) {
            case 'theme':
                add_action('after_switch_theme', array('WPAdminButtons_AdminPageFramework_WPUtility', 'FlushRewriteRules'));
            break;
            case 'plugin':
                register_activation_hook($sCallerPath, array('WPAdminButtons_AdminPageFramework_WPUtility', 'FlushRewriteRules'));
                register_deactivation_hook($sCallerPath, array('WPAdminButtons_AdminPageFramework_WPUtility', 'FlushRewriteRules'));
            break;
        }
    }
}
class WPAdminButtons_AdminPageFramework_Property_Widget extends WPAdminButtons_AdminPageFramework_Property_Base {
...
class WPAdminButtons_AdminPageFramework_Property_NetworkAdmin extends WPAdminButtons_AdminPageFramework_Property_Page {
    public $_sPropertyType = 'network_admin_page';
    public $sFieldsType = 'network_admin_page';
    protected function _getOptions() {
        return WPAdminButtons_AdminPageFramework_WPUtility::addAndApplyFilter($GLOBALS['aWPAdminButtons_AdminPageFramework']['aPageClasses'][$this->sClassName], 'options_' . $this->sClassName, $this->sOptionKey ? get_site_option($this->sOptionKey, array()) : array());
    }
    public function updateOption($aOptions = null) {
        if ($this->_bDisableSavingOptions) {
            return;
...
class WPAdminButtons_AdminPageFramework_Property_MetaBox_Page extends WPAdminButtons_AdminPageFramework_Property_MetaBox {
    ...
    function __construct($oCaller, $sClassName, $sCapability = 'manage_options', $sTextDomain = 'admin-page-framework', $sFieldsType = 'page_meta_box') {
        ...
        $GLOBALS['aWPAdminButtons_AdminPageFramework']['aMetaBoxForPagesClasses'] = isset($GLOBALS['aWPAdminButtons_AdminPageFramework']['aMetaBoxForPagesClasses']) && is_array($GLOBALS['aWPAdminButtons_AdminPageFramework']['aMetaBoxForPagesClasses']) ? $GLOBALS['aWPAdminButtons_AdminPageFramework']['aMetaBoxForPagesClasses'] : array();
        $GLOBALS['aWPAdminButtons_AdminPageFramework']['aMetaBoxForPagesClasses'][$sClassName] = $oCaller;
    }
    ...
    private function _getOwnerObjectOfPage($sPageSlug) {
        if (!isset($GLOBALS['aWPAdminButtons_AdminPageFramework']['aPageClasses'])) {
            return null;
        }
        if (!is_array($GLOBALS['aWPAdminButtons_AdminPageFramework']['aPageClasses'])) {
            return null;
        }
        foreach ($GLOBALS['aWPAdminButtons_AdminPageFramework']['aPageClasses'] as $__oClass) {
...
class WPAdminButtons_AdminPageFramework_Property_TaxonomyField extends WPAdminButtons_AdminPageFramework_Property_MetaBox {
    public $_sPropertyType = 'taxonomy_field';
    public $aTaxonomySlugs;
    public $sOptionKey;
}
class WPAdminButtons_AdminPageFramework_Property_UserMeta extends WPAdminButtons_AdminPageFramework_Property_MetaBox {
    public $_sPropertyType = 'user_meta';
    protected function _getOptions() {
        return array();
    }
}
class WPAdminButtons_AdminPageFramework_ErrorReporting {
...
class WPAdminButtons_AdminPageFramework_RegisterClasses {
...
abstract class WPAdminButtons_AdminPageFramework_Utility_String {
...
abstract class WPAdminButtons_AdminPageFramework_Utility_Array extends WPAdminButtons_AdminPageFramework_Utility_String {
...
abstract class WPAdminButtons_AdminPageFramework_Utility_Path extends WPAdminButtons_AdminPageFramework_Utility_Array {
...
abstract class WPAdminButtons_AdminPageFramework_Utility_URL extends WPAdminButtons_AdminPageFramework_Utility_Path {
...
abstract class WPAdminButtons_AdminPageFramework_Utility_File extends WPAdminButtons_AdminPageFramework_Utility_URL {
...
abstract class WPAdminButtons_AdminPageFramework_Utility_SystemInformation extends WPAdminButtons_AdminPageFramework_Utility_File {
...
abstract class WPAdminButtons_AdminPageFramework_Utility extends WPAdminButtons_AdminPageFramework_Utility_SystemInformation {
...
class WPAdminButtons_AdminPageFramework_WPUtility_URL extends WPAdminButtons_AdminPageFramework_Utility {
    ...
    static public function getQueryAdminURL($aAddingQueries = array(), $aRemovingQueryKeys = array(), $sSubjectURL = '') {
        $_sAdminURL = is_network_admin() ? network_admin_url(WPAdminButtons_AdminPageFramework_WPUtility_Page::getPageNow()) : admin_url(WPAdminButtons_AdminPageFramework_WPUtility_Page::getPageNow());
    ...
    static public function getSRCFromPath($sFilePath) {
        ...
        $sRelativePath = WPAdminButtons_AdminPageFramework_Utility::getRelativePath(ABSPATH, $sFilePath);
...
class WPAdminButtons_AdminPageFramework_WPUtility_HTML extends WPAdminButtons_AdminPageFramework_WPUtility_URL {
    static public function generateAttributes(array $aAttributes) {
...
class WPAdminButtons_AdminPageFramework_WPUtility_Page extends WPAdminButtons_AdminPageFramework_WPUtility_HTML {
...
class WPAdminButtons_AdminPageFramework_WPUtility_Hook extends WPAdminButtons_AdminPageFramework_WPUtility_Page {
...
class WPAdminButtons_AdminPageFramework_WPUtility_File extends WPAdminButtons_AdminPageFramework_WPUtility_Hook {
...
class WPAdminButtons_AdminPageFramework_WPUtility_Option extends WPAdminButtons_AdminPageFramework_WPUtility_File {
...
class WPAdminButtons_AdminPageFramework_WPUtility_Post extends WPAdminButtons_AdminPageFramework_WPUtility_Option {
...
class WPAdminButtons_AdminPageFramework_WPUtility_SystemInformation extends WPAdminButtons_AdminPageFramework_WPUtility_Post {
...
class WPAdminButtons_AdminPageFramework_WPUtility extends WPAdminButtons_AdminPageFramework_WPUtility_SystemInformation {
...
abstract class WPAdminButtons_AdminPageFramework_CustomSubmitFields extends WPAdminButtons_AdminPageFramework_WPUtility {
...
class WPAdminButtons_AdminPageFramework_FormEmail extends WPAdminButtons_AdminPageFramework_WPUtility {
...
abstract class WPAdminButtons_AdminPageFramework_Link_Base extends WPAdminButtons_AdminPageFramework_WPUtility {
...
class WPAdminButtons_AdminPageFramework_Link_Page extends WPAdminButtons_AdminPageFramework_Link_Base {
    public $oProp;
...
class WPAdminButtons_AdminPageFramework_FormElement_Utility extends WPAdminButtons_AdminPageFramework_WPUtility {
...
class WPAdminButtons_AdminPageFramework_FormElement extends WPAdminButtons_AdminPageFramework_FormElement_Utility {
    ...
    public function addField($asField) {
        ...
        $_aFIeld = $asField;
        $this->_sTargetSectionID = isset($_aFIeld['section_id']) ? $_aFIeld['section_id'] : $this->_sTargetSectionID;
...
class WPAdminButtons_AdminPageFramework_FormElement_Page extends WPAdminButtons_AdminPageFramework_FormElement {
...
class WPAdminButtons_AdminPageFramework_Debug extends WPAdminButtons_AdminPageFramework_WPUtility {
    ...
    static public function log($vValue, $sFilePath = null) {
        ...
        $_sHeading = date("Y/m/d H:i:s", $_nNow) . '.' . $_nMicroseconds . ' ' . $_sElapsed . '.' . $_sElapsedFloat . ' ' . $_iPageLoadID . ' ' . WPAdminButtons_AdminPageFramework_Registry::Version . (WPAdminButtons_AdminPageFramework_Registry::$bIsMinifiedVersion ? '.min' : '') . ' ' . "{$_sCallerClasss}::{$_sCallerFunction} " . current_filter() . ' ' . self::getCurrentURL() . ' ';
...
abstract class WPAdminButtons_AdminPageFramework_HelpPane_Base extends WPAdminButtons_AdminPageFramework_Debug {
    protected $_oScreen;
    function __construct($oProp) {
        $this->oProp = $oProp;
        $this->oUtil = new WPAdminButtons_AdminPageFramework_WPUtility;
...
class WPAdminButtons_AdminPageFramework_HelpPane_Page extends WPAdminButtons_AdminPageFramework_HelpPane_Base {
...
abstract class WPAdminButtons_AdminPageFramework_FieldType_Base extends WPAdminButtons_AdminPageFramework_WPUtility {
    ...
    function __construct($asClassName = 'admin_page_framework', $asFieldTypeSlug = null, $oMsg = null, $bAutoRegister = true) {
        ...
        $this->oMsg = $oMsg ? $oMsg : WPAdminButtons_AdminPageFramework_Message::getInstance();
        if ($bAutoRegister) {
    ...
    protected function geFieldOutput(array $aField) {
        ...
        $_oField = new WPAdminButtons_AdminPageFramework_FormField($aField, $_aOptions, $_oCaller->getFieldErrors(), $_oCaller->oProp->aFieldTypeDefinitions, $_oCaller->oMsg, $_oCaller->oProp->aFieldCallbacks);
    ...
    protected function enqueueMediaUploader() {
        ...
        if (function_exists('wp_enqueue_media')) {
            new WPAdminButtons_AdminPageFramework_Script_MediaUploader($this->oMsg);
        } else {
...
abstract class WPAdminButtons_AdminPageFramework_FieldType extends WPAdminButtons_AdminPageFramework_FieldType_Base {
    public function _replyToFieldLoader() {
        $this->setUp();
    }
    public function _replyToGetScripts() {
...
abstract class WPAdminButtons_AdminPageFramework_FormOutput extends WPAdminButtons_AdminPageFramework_WPUtility {
...
class WPAdminButtons_AdminPageFramework_FormField_Base extends WPAdminButtons_AdminPageFramework_FormOutput {
    public $aField = array();
    public $aFIeldTypeDefinitions = array();
    ...
    private function _loadScripts($sFieldsType = '') {
        if ('widget' === $sFieldsType && !self::$_bIsLoadedSScripts_Widget) {
            new WPAdminButtons_AdminPageFramework_Script_Widget;
        ...
        new WPAdminButtons_AdminPageFramework_Script_Utility;
        new WPAdminButtons_AdminPageFramework_Script_OptionStorage;
        new WPAdminButtons_AdminPageFramework_Script_AttributeUpdator;
        new WPAdminButtons_AdminPageFramework_Script_RepeatableField($this->oMsg);
        new WPAdminButtons_AdminPageFramework_Script_Sortable;
        new WPAdminButtons_AdminPageFramework_Script_RegisterCallback;
    }
...
class WPAdminButtons_AdminPageFramework_FormField extends WPAdminButtons_AdminPageFramework_FormField_Base {
...
abstract class WPAdminButtons_AdminPageFramework_Input_Base extends WPAdminButtons_AdminPageFramework_WPUtility {
    public $aField = array();
    public $aOptions = array();
...
class WPAdminButtons_AdminPageFramework_ExportOptions extends WPAdminButtons_AdminPageFramework_CustomSubmitFields {
    ...
    public function doExport($vData, $sFileName = null, $sFormatType = null) {
        ...
        switch (strtolower($sFormatType)) {
            case 'text':
                if (is_array($vData) || is_object($vData)) die(WPAdminButtons_AdminPageFramework_Debug::getArray($vData, null, false));
                die($vData);
            case 'json':
...
class WPAdminButtons_AdminPageFramework_ImportOptions extends WPAdminButtons_AdminPageFramework_CustomSubmitFields {
...
class WPAdminButtons_AdminPageFramework_Link_PostType extends WPAdminButtons_AdminPageFramework_Link_Base {
    public $aFooterInfo = array('sLeft' => '', 'sRight' => '',);
    public function __construct($oProp, $oMsg = null) {
        if (!$oProp->bIsAdmin) {
            return;
...
class WPAdminButtons_AdminPageFramework_Link_NetworkAdmin extends WPAdminButtons_AdminPageFramework_Link_Page {
    public $oProp;
    public function __construct(&$oProp, $oMsg = null) {
        if (!$oProp->bIsAdmin) {
            return;
...
class WPAdminButtons_AdminPageFramework_HelpPane_MetaBox extends WPAdminButtons_AdminPageFramework_HelpPane_Base {
    function __construct($oProp) {
        parent::__construct($oProp);
        if ($oProp->bIsAdminAjax) {
            return;
...
class WPAdminButtons_AdminPageFramework_FieldType_image extends WPAdminButtons_AdminPageFramework_FieldType_Base {
...
class WPAdminButtons_AdminPageFramework_FieldType_checkbox extends WPAdminButtons_AdminPageFramework_FieldType {
    public $aFieldTypeSlugs = array('checkbox');
    protected $aDefaultKeys = array('select_all_button' => false, 'select_none_button' => false,);
    protected function getScripts() {
        new WPAdminButtons_AdminPageFramework_Script_CheckboxSelector;
    ...
    protected function getField($aField) {
        $_aOutput = array();
        $_oCheckbox = new WPAdminButtons_AdminPageFramework_Input_checkbox($aField);
...
class WPAdminButtons_AdminPageFramework_FieldType_color extends WPAdminButtons_AdminPageFramework_FieldType {
...
class WPAdminButtons_AdminPageFramework_FieldType_default extends WPAdminButtons_AdminPageFramework_FieldType {
...
class WPAdminButtons_AdminPageFramework_FieldType_hidden extends WPAdminButtons_AdminPageFramework_FieldType {
...
class WPAdminButtons_AdminPageFramework_FieldType_radio extends WPAdminButtons_AdminPageFramework_FieldType {
    ...
    protected function getField($aField) {
        $_aOutput = array();
        $_oRadio = new WPAdminButtons_AdminPageFramework_Input_radio($aField);
...
class WPAdminButtons_AdminPageFramework_FieldType_section_title extends WPAdminButtons_AdminPageFramework_FieldType {
...
class WPAdminButtons_AdminPageFramework_FieldType_select extends WPAdminButtons_AdminPageFramework_FieldType {
    ...
    protected function getField($aField) {
        $_oSelectInput = new WPAdminButtons_AdminPageFramework_Input_select($aField);
...
class WPAdminButtons_AdminPageFramework_FieldType_submit extends WPAdminButtons_AdminPageFramework_FieldType {
...
class WPAdminButtons_AdminPageFramework_FieldType_export extends WPAdminButtons_AdminPageFramework_FieldType_submit {
...
class WPAdminButtons_AdminPageFramework_FieldType_import extends WPAdminButtons_AdminPageFramework_FieldType_submit {
...
class WPAdminButtons_AdminPageFramework_FieldType_system extends WPAdminButtons_AdminPageFramework_FieldType {
    ...
    private function _getPHPInfo() {
        ...
        $_oErrorReporting = new WPAdminButtons_AdminPageFramework_ErrorReporting;
...
class WPAdminButtons_AdminPageFramework_FieldType_taxonomy extends WPAdminButtons_AdminPageFramework_FieldType {
...
class WPAdminButtons_AdminPageFramework_FieldType_text extends WPAdminButtons_AdminPageFramework_FieldType {
...
class WPAdminButtons_AdminPageFramework_FieldType_file extends WPAdminButtons_AdminPageFramework_FieldType_text {
...
class WPAdminButtons_AdminPageFramework_FieldType_number extends WPAdminButtons_AdminPageFramework_FieldType_text {
...
class WPAdminButtons_AdminPageFramework_FieldType_textarea extends WPAdminButtons_AdminPageFramework_FieldType {
...
class WPAdminButtons_AdminPageFramework_FormTable_Base extends WPAdminButtons_AdminPageFramework_FormOutput {
    ...
    private function _loadScripts() {
        ...
        new WPAdminButtons_AdminPageFramework_Script_Tab;
    }
    ...
    protected function _getCollapsibleSectionsEnablerScript() {
        ...
        new WPAdminButtons_AdminPageFramework_Script_CollapsibleSection($this->oMsg);
    }
    ...
    protected function _getRepeatableSectionsEnablerScript($sContainerTagID, $iSectionCount, $aSettings) {
        ...
        new WPAdminButtons_AdminPageFramework_Script_RepeatableSection($this->oMsg);
...
class WPAdminButtons_AdminPageFramework_Input_checkbox extends WPAdminButtons_AdminPageFramework_Input_Base {
    public function get() {
...
class WPAdminButtons_AdminPageFramework_Input_radio extends WPAdminButtons_AdminPageFramework_Input_Base {
    public function get() {
        $_aParams = func_get_args() + array(0 => '', 1 => array());
        $_sLabel = $_aParams[0];
        $_aAttributes = $_aParams[1];
...
class WPAdminButtons_AdminPageFramework_Input_select extends WPAdminButtons_AdminPageFramework_Input_Base {
    public $aStructureOptions = array('input_container_tag' => 'span', 'input_container_attributes' => array('class' => 'admin-page-framework-input-container',), 'label_container_tag' => 'span', 'label_container_attributes' => array('class' => 'admin-page-framework-input-label-string',),);
    public function get() {
...
class WPAdminButtons_AdminPageFramework_HelpPane_MetaBox_Page extends WPAdminButtons_AdminPageFramework_HelpPane_MetaBox {
    protected function _isInThePage() {
...
class WPAdminButtons_AdminPageFramework_HelpPane_TaxonomyField extends WPAdminButtons_AdminPageFramework_HelpPane_MetaBox {
    public function _replyToRegisterHelpTabTextForMetaBox() {
        $this->_setHelpTab($this->oProp->sMetaBoxID, $this->oProp->sTitle, $this->oProp->aHelpTabText, $this->oProp->aHelpTabTextSide);
    }
}
class WPAdminButtons_AdminPageFramework_HelpPane_UserMeta extends WPAdminButtons_AdminPageFramework_HelpPane_MetaBox {
}
class WPAdminButtons_AdminPageFramework_HelpPane_Widget extends WPAdminButtons_AdminPageFramework_HelpPane_MetaBox {
}
class WPAdminButtons_AdminPageFramework_FieldType_media extends WPAdminButtons_AdminPageFramework_FieldType_image {
...
class WPAdminButtons_AdminPageFramework_FieldType_posttype extends WPAdminButtons_AdminPageFramework_FieldType_checkbox {
...
class WPAdminButtons_AdminPageFramework_FieldType_size extends WPAdminButtons_AdminPageFramework_FieldType_select {
    ...
    protected function getField($aField) {
        ...
        $_oUnitInput = new WPAdminButtons_AdminPageFramework_Input_select($_aUnitField);
...
class WPAdminButtons_AdminPageFramework_FormTable_Row extends WPAdminButtons_AdminPageFramework_FormTable_Base {
    ...
    private function _getFieldRow(array $aField, $hfCallback) {
        ...
        return $this->_getFieldByContainer($aField, $_aFieldFinal, $hfCallback, array('open_container' => "<tr " . $this->_getFieldContainerAttributes($_aFieldFinal, array('id' => 'fieldrow-' . WPAdminButtons_AdminPageFramework_FormField::_getInputTagBaseID($_aFieldFinal), 'valign' => 'top', 'class' => 'admin-page-framework-fieldrow',), 'fieldrow') . ">", 'close_container' => "</tr>", 'open_title' => "<th>", 'close_title' => "</th>", 'open_main' => "<td " . $this->generateAttributes(array('colspan' => $_aFieldFinal['show_title_column'] ? 1 : 2, 'class' => $_aFieldFinal['show_title_column'] ? null : 'admin-page-framework-field-td-no-title',)) . ">", 'close_main' => "</td>",));
    }
    ...
    private function _getFieldTitle(array $aField) {
        return "<label for='" . WPAdminButtons_AdminPageFramework_FormField::_getInputID($aField) . "'>" . "<a id='{$aField['field_id']}'></a>" . "<span title='" . esc_attr(strip_tags(isset($aField['tip']) ? $aField['tip'] : (is_array($aField['description'] ? implode('&#10;', $aField['description']) : $aField['description'])))) . "'>" . $aField['title'] . (in_array($aField['_fields_type'], array('widget', 'post_meta_box', 'page_meta_box')) && isset($aField['title']) && '' !== $aField['title'] ? "<span class='title-colon'>:</span>" : '') . "</span>" . "</label>";
    }
}
abstract class WPAdminButtons_AdminPageFramework_FormTable_Caption extends WPAdminButtons_AdminPageFramework_FormTable_Row {
...
class WPAdminButtons_AdminPageFramework_FormTable extends WPAdminButtons_AdminPageFramework_FormTable_Caption {
...
class WPAdminButtons_AdminPageFramework_FieldTypeRegistration {
    ...
    static public function register($aFieldTypeDefinitions, $sExtendedClassName, $oMsg) {
        foreach (self::$aDefaultFieldTypeSlugs as $_sFieldTypeSlug) {
            $_sFieldTypeClassName = "WPAdminButtons_AdminPageFramework_FieldType_{$_sFieldTypeSlug}";
...
abstract class WPAdminButtons_AdminPageFramework_PageLoadInfo_Base {
...
class WPAdminButtons_AdminPageFramework_PageLoadInfo_Page extends WPAdminButtons_AdminPageFramework_PageLoadInfo_Base {
    private static $_oInstance;
    private static $aClassNames = array();
    public static function instantiate($oProp, $oMsg) {
        if (in_array($oProp->sClassName, self::$aClassNames)) return self::$_oInstance;
        self::$aClassNames[] = $oProp->sClassName;
        self::$_oInstance = new WPAdminButtons_AdminPageFramework_PageLoadInfo_Page($oProp, $oMsg);
...
class WPAdminButtons_AdminPageFramework_PageLoadInfo_NetworkAdminPage extends WPAdminButtons_AdminPageFramework_PageLoadInfo_Base {
    private static $_oInstance;
    private static $aClassNames = array();
    function __construct($oProp, $oMsg) {
    ...
    public static function instantiate($oProp, $oMsg) {
        ...
        if (in_array($oProp->sClassName, self::$aClassNames)) return self::$_oInstance;
        self::$aClassNames[] = $oProp->sClassName;
        self::$_oInstance = new WPAdminButtons_AdminPageFramework_PageLoadInfo_NetworkAdminPage($oProp, $oMsg);
        return self::$_oInstance;
    }
    public function _replyToSetPageLoadInfoInFooter() {
        if ($this->oProp->isPageAdded()) {
...
class WPAdminButtons_AdminPageFramework_PageLoadInfo_PostType extends WPAdminButtons_AdminPageFramework_PageLoadInfo_Base {
    private static $_oInstance;
    private static $aClassNames = array();
    public static function instantiate($oProp, $oMsg) {
        if (in_array($oProp->sClassName, self::$aClassNames)) return self::$_oInstance;
        self::$aClassNames[] = $oProp->sClassName;
        self::$_oInstance = new WPAdminButtons_AdminPageFramework_PageLoadInfo_PostType($oProp, $oMsg);
        return self::$_oInstance;
    }
    public function _replyToSetPageLoadInfoInFooter() {
        ...
        if (WPAdminButtons_AdminPageFramework_WPUtility::getCurrentPostType() == $this->oProp->sPostType || WPAdminButtons_AdminPageFramework_WPUtility::isPostDefinitionPage($this->oProp->sPostType) || WPAdminButtons_AdminPageFramework_WPUtility::isCustomTaxonomyPage($this->oProp->sPostType)) {
            add_filter('update_footer', array($this, '_replyToGetPageLoadInfo'), 999);
        }
    }
}
class WPAdminButtons_AdminPageFramework_WalkerTaxonomyChecklist extends Walker_Category {
    function start_el(&$sOutput, $oTerm, $iDepth = 0, $aArgs = array(), $iCurrentObjectID = 0) {
        ...
        $sOutput.= "\n" . "<li " . WPAdminButtons_AdminPageFramework_WPUtility::generateAttributes($_aLiTagAttributes) . ">" . "<label for='{$_sID}' class='taxonomy-checklist-label'>" . "<input value='0' type='hidden' name='{$aArgs['name']}[{$_iID}]' class='apf_checkbox' />" . "<input " . WPAdminButtons_AdminPageFramework_WPUtility::generateAttributes($_aInputAttributes) . " />" . esc_html(apply_filters('the_category', $oTerm->name)) . $_sPostCount . "</label>";
    }
}
class WPAdminButtons_AdminPageFramework_Script_Base {
...
class WPAdminButtons_AdminPageFramework_Script_AttributeUpdator extends WPAdminButtons_AdminPageFramework_Script_Base {
    static public function getScript() {
        $_aParams = func_get_args() + array(null);
        $_oMsg = $_aParams[0];
...
class WPAdminButtons_AdminPageFramework_Script_CheckboxSelector extends WPAdminButtons_AdminPageFramework_Script_Base {
    static public function getScript() {
        $_aParams = func_get_args() + array(null);
        $_oMsg = $_aParams[0];
...
class WPAdminButtons_AdminPageFramework_Script_CollapsibleSection extends WPAdminButtons_AdminPageFramework_Script_Base {
    protected function construct() {
...
class WPAdminButtons_AdminPageFramework_Script_MediaUploader extends WPAdminButtons_AdminPageFramework_Script_Base {
    protected function construct() {
        wp_enqueue_script('jquery');
        if (function_exists('wp_enqueue_media')) {
...
class WPAdminButtons_AdminPageFramework_Script_OptionStorage extends WPAdminButtons_AdminPageFramework_Script_Base {
    static public function getScript() {
        $_aParams = func_get_args() + array(null);
        $_oMsg = $_aParams[0];
...
class WPAdminButtons_AdminPageFramework_Script_RegisterCallback extends WPAdminButtons_AdminPageFramework_Script_Base {
    static public function getScript() {
        $_aParams = func_get_args() + array(null);
        $_oMsg = $_aParams[0];
...
class WPAdminButtons_AdminPageFramework_Script_RepeatableField extends WPAdminButtons_AdminPageFramework_Script_Base {
    static public function getScript() {
        $_aParams = func_get_args() + array(null);
        $_oMsg = $_aParams[0];
...
class WPAdminButtons_AdminPageFramework_Script_RepeatableSection extends WPAdminButtons_AdminPageFramework_Script_Base {
    static public function getScript() {
        $_aParams = func_get_args() + array(null);
        $_oMsg = $_aParams[0];
...
class WPAdminButtons_AdminPageFramework_Script_Sortable extends WPAdminButtons_AdminPageFramework_Script_Base {
    protected function construct() {
...
class WPAdminButtons_AdminPageFramework_Script_Tab extends WPAdminButtons_AdminPageFramework_Script_Base {
    static public function getScript() {
        $_aParams = func_get_args() + array(null);
        $_oMsg = $_aParams[0];
...
class WPAdminButtons_AdminPageFramework_Script_Utility extends WPAdminButtons_AdminPageFramework_Script_Base {
    static public function getScript() {
        $_aParams = func_get_args() + array(null);
        $_oMsg = $_aParams[0];
...
class WPAdminButtons_AdminPageFramework_Script_Widget extends WPAdminButtons_AdminPageFramework_Script_Base {
    static public function getScript() {
        $_aParams = func_get_args() + array(null);
        $_oMsg = $_aParams[0];
...
class WPAdminButtons_AdminPageFramework_Widget_Factory extends WP_Widget {
    ...
    public function form($aFormData) {
        ...
        $this->oCaller->oForm = new WPAdminButtons_AdminPageFramework_FormElement($this->oCaller->oProp->sFieldsType, $this->oCaller->oProp->sCapability, $this->oCaller);
    }
...
class WPAdminButtons_AdminPageFramework_AdminNotice {
...
abstract class WPAdminButtons_AdminPageFramework_PluginBootstrap {
    public $sFilePath;
    public $bIsAdmin;
    public $sHookPrefix;
    ...
    protected function _registerClasses() {
        if (!class_exists('WPAdminButtons_AdminPageFramework_RegisterClasses')) {
            return;
        }
        new WPAdminButtons_AdminPageFramework_RegisterClasses($this->getScanningDirs(), array(), $this->getClasses());
    }
...
class WPAdminButtons_AdminPageFramework_Requirement {
...
class WPAdminButtons_AdminPageFramework_TableOfContents {
...
class WPAdminButtons_AdminPageFramework_WPReadmeParser {
    ...
    private function _getParsedText($sContent) {
        ...
        $_oParsedown = new WPAdminButtons_AdminPageFramework_Parsedown();
...
class WPAdminButtons_AdminPageFramework_Parsedown {
    function text($text) {
